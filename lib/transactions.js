...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, coinbase){
    ...
    var scriptSigPart1;
    if (typeof(rpcData.coinbaseaux.flags) == "undefined") {
